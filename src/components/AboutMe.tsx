          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-col h-full">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">@submjn</p>
              </div>
              ...
              <div className="flex-1 bg-gray-50 dark:bg-[#1E2330] rounded-lg p-4 mb-8 mt-4">
                <div className="space-y-3">
                  <p className="text-md text-gray-600 dark:text-gray-300 leading-relaxed">
                    Hey there, I&apos;m Subash, a Software Developer based in Charlottesville, Virginia. 
              ...
              <div className="mt-auto">
                <div className="flex items-center space-x-4">
                  ...
                  <a 
                    href="https://linkedin.com/in/subashmaharjan" 
                    target="_blank"
                    rel="noopener noreferrer"
